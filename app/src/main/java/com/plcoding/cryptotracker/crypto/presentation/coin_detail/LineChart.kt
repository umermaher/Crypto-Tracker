...
fun LineChart(
    ...
    Canvas(
        ...
        // maxXLabelHeight = 99, maxXLabelLineCount = 3 then single xLabelLineHeight = 33
        ...
        // e.g. max = 2659 and min 2583
        // then we get 2659, 2621, and 2583
...
//        )
        ...
        xLabelTextLayoutResults.forEachIndexed { index, textLayoutResult ->
            val x = viewPortLeftX +
                    xAxisLabelSpacingPx / 2 + xLabelWidth * index
            drawText(
            ...
            if(selectedDataPointIndex == index) {
                ...
                } + textLayoutResult.size.width / 2
                // e.g. textPositionX = 400, size.width = 1000, then isTextInVisibleRange = true
                // e.g. textPositionX = 1400, size.width = 1000, then isTextInVisibleRange = false
        ...
        for(i in 1 until drawPoints.size) {
            ...
            // if p0.x = 50 and p1.x = 100 then connection point must be 75 in between and y remain same
            val x = (p1.x + p0.x) / 2f
            val y1 = p0.y
            val y2 = p1.y
        ...
        drawPoints = visibleDataPointIndices.map {
            ...
            // [0; 1000]
            // if dataPoints[it].y = 500, then ratio = 0.50%
...
private fun getSelectedDataPointIndex(
    ...
    // touchOffsetX = 150 and triggerWidth = 100 then triggerRangeLeft = 100 and triggerRangeRight = 200
